...
- `MailRelay/FoodDiary.MailRelay.WebApi/appsettings.json`
- `MailRelay/FoodDiary.MailRelay.WebApi/appsettings.{Environment}.json`
...
```bash
dotnet user-secrets set "ConnectionStrings:DefaultConnection" "Host=localhost;Database=fooddiary_mailrelay;Username=postgres;Password=..." --project MailRelay/FoodDiary.MailRelay.Initializer
```
