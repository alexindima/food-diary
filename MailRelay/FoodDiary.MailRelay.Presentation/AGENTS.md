...
## Scope
Rules for `MailRelay/FoodDiary.MailRelay.Presentation/`.
...
- Do not reference `MailRelay/FoodDiary.MailRelay.Infrastructure`.
- May reference `MailRelay/FoodDiary.MailRelay.Application` and `MailRelay/FoodDiary.MailRelay.Client`.
- Do not reference `MailRelay/FoodDiary.MailRelay.WebApi`.
...
## Commands
- Build: `dotnet build MailRelay/FoodDiary.MailRelay.Presentation/FoodDiary.MailRelay.Presentation.csproj`
