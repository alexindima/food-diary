...
public static class ConsumptionHttpQueryMappings {
    extension(GetConsumptionsHttpQuery query) {
        public GetConsumptionsQuery ToQuery(Guid userId) {
    ...
    extension(GetConsumptionsOverviewHttpQuery query) {
        public GetConsumptionsOverviewQuery ToQuery(Guid userId) {
    ...
    extension(Guid id) {
        public GetConsumptionByIdQuery ToQuery(Guid userId) {
