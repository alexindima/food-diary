...
public sealed class TdeeModuleExtractionTests {
    ...
    public void TdeeLogicalModule_DoesNotCreateUnownedLayers() {
        ...
        Assert.True(File.Exists(ArchitectureTestPaths.FromRoot("Modules", "Users", "Domain", "Entities", "User.Tdee.cs")));
    ...
    public void TdeeApplicationAssembly_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Application.Contracts", "FoodDiary.Mediator", "FoodDiary.Modules.BodyMetrics.Contracts", "FoodDiary.Modules.Exercises.Contracts", "FoodDiary.Modules.Meals.Contracts", "FoodDiary.Modules.Tdee.Contracts", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain.Contracts"], references);
    }
