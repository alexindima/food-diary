...
public sealed class UsersModuleExtractionTests {
    ...
    public void UsersContracts_HaveOnlyApprovedTypesAndSharedPrimitiveDependency() {
        ...
        Assert.Equal(["Enums/ActivityLevel.cs", "Enums/RoleNames.cs", "ValueObjects/DesiredWaistCm.cs", "ValueObjects/DesiredWeightKg.cs", "ValueObjects/Ids/UserId.cs", "ValueObjects/LanguageCode.cs", "ValueObjects/UserCalorieSchedule.cs", "ValueObjects/UserPreferenceUpdate.cs"],
    ...
    public void ActivityLevel_IsOwnedOnlyByUsersDomainContracts() {
        Type enumType = typeof(FoodDiary.Modules.Users.Domain.Contracts.Enums.ActivityLevel);
        Assert.Equal("FoodDiary.Modules.Users.Domain.Contracts", enumType.Assembly.GetName().Name);
        Assert.Equal("FoodDiary.Modules.Users.Domain.Contracts.Enums", enumType.Namespace);
    ...
    public void UsersAggregateFiles_HaveOnePhysicalOwner(string fileName) {
        Assert.True(File.Exists(ArchitectureTestPaths.FromRoot(
            "Modules", "Users", "Domain", "Entities", fileName)));
    ...
    public void GoalsAndMappings_BelongToUsers(string name) {
        ...
        Assert.True(File.Exists(ArchitectureTestPaths.FromRoot(
            "Modules", "Users", "PersistenceModel", "Persistence", "Configurations", "BodyMetrics", name + "Configuration.cs")));
        Assert.False(File.Exists(ArchitectureTestPaths.FromRoot(
    ...
    public void CoreApplication_DoesNotReferenceExtractedUsersAssembly() {
        ...
        Assert.DoesNotContain("FoodDiary.Modules.Users.Application", references, StringComparer.Ordinal);
    }
