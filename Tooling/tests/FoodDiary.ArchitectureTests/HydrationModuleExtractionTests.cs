...
public sealed class HydrationModuleExtractionTests {
    ...
    public void HydrationRuntimeContextAndCoordinatedSaveRemainExplicit() {
        ...
        Assert.DoesNotContain("FoodDiary.Modules.Users.Domain.Entities", context, StringComparison.Ordinal);
    }
    ...
    public void HydrationDomain_LivesOnlyInModuleProject_WithoutInverseUserNavigation() {
        ...
        string userSource = File.ReadAllText(ArchitectureTestPaths.FromRoot("Modules", "Users", "Domain", "Entities", "User.cs"));
