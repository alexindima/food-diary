...
public sealed class SolutionModuleFolderTests {
    ...
    [InlineData("Tooling", "FoodDiary.ArchitectureTests")]
    [InlineData("Hosts", "FoodDiary.Web.Api.Tests")]
    [InlineData("Hosts", "FoodDiary.Web.Api.IntegrationTests")]
    [InlineData("Hosts", "FoodDiary.JobManager.Tests")]
    [InlineData("Hosts", "FoodDiary.Telegram.Bot.Tests")]
    [InlineData("Platform", "FoodDiary.Infrastructure.Tests")]
    [InlineData("Platform", "FoodDiary.Infrastructure.IntegrationTests")]
    [InlineData("Platform", "FoodDiary.Presentation.Api.Tests")]
    ...
    public void SharedAndToolingTests_ReuseCentralTestBuildSettings(string owner) {
        ...
        string expected = string.Equals(owner, "Tooling", StringComparison.Ordinal) ? "../Testing/TestProjects.props" : "../../Tooling/Testing/TestProjects.props";
        Assert.Contains(expected, imports, StringComparer.Ordinal);
    }
                ...
                if (segments.Length > 2 && string.Equals(segments[2], "tests", StringComparison.OrdinalIgnoreCase)) {
                    expectedPrefix += "Tests/";
                       ...
                       (string.Equals(segments[0], "Shared", StringComparison.OrdinalIgnoreCase) ||
                        ...
                        string.Equals(segments[0], "Hosts", StringComparison.OrdinalIgnoreCase) ||
                        string.Equals(segments[0], "Platform", StringComparison.OrdinalIgnoreCase)) &&
