...
public sealed class UsersRepositoryOwnershipTests {
    ...
    public void TrackedRepositoryAndTests_BelongToUsers_WithoutCentralRegistrationOrImplicitSave() {
        Assert.Multiple(
            ...
            () => Assert.False(File.Exists(ArchitectureTestPaths.FromRoot("Platform/tests/FoodDiary.Infrastructure.IntegrationTests/Integration/UserRepositoryIntegrationTests.cs"))),
