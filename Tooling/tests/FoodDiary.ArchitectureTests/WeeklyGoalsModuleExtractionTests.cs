...
public sealed class WeeklyGoalsModuleExtractionTests {
    ...
    public void ExtractedWeeklyGoalsAssembly_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Application.Contracts", "FoodDiary.Mediator", "FoodDiary.Modules.Meals.Contracts", "FoodDiary.Modules.Notifications.Contracts", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain.Contracts", "FoodDiary.Modules.WeeklyGoals.Application.Abstractions", "FoodDiary.Modules.WeeklyGoals.Contracts", "FoodDiary.Modules.WeeklyGoals.Domain"], references);
    }
    ...
    public void WeeklyGoalsDomainSource_LivesOnlyInExtractedAssembly() {
        ...
        Assert.True(File.Exists(ArchitectureTestPaths.FromRoot("Modules", "WeeklyGoals", "Domain", "Entities", "WeeklyGoal.cs")));
    ...
    public void ExtractedWeeklyGoalsDomain_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Modules.Users.Domain.Contracts"], references);
    }
    ...
    public void WeeklyGoalsPersistence_LivesOnlyInModuleProjects() {
        ...
        Assert.True(File.Exists(ArchitectureTestPaths.FromRoot("Modules", "WeeklyGoals", "PersistenceModel", "Configurations", "WeeklyGoalConfiguration.cs")));
    }
