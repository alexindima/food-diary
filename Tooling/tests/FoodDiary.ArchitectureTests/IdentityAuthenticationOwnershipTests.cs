...
public sealed class IdentityAuthenticationOwnershipTests {
    ...
    [InlineData("Platform/tests/FoodDiary.Infrastructure.Tests/Authentication/AdminSsoServiceTests.cs", "Modules/Identity/tests/FoodDiary.Modules.Identity.Infrastructure.Tests/Authentication/AdminSsoServiceTests.cs")]
    [InlineData("Platform/tests/FoodDiary.Infrastructure.Tests/Authentication/JwtTokenGeneratorTests.cs", "Modules/Identity/tests/FoodDiary.Modules.Identity.Infrastructure.Tests/Authentication/JwtTokenGeneratorTests.cs")]
    [InlineData("Platform/tests/FoodDiary.Infrastructure.Tests/Services/PasswordHasherTests.cs", "Modules/Identity/tests/FoodDiary.Modules.Identity.Infrastructure.Tests/Authentication/PasswordHasherTests.cs")]
    ...
    public void SharedAuthentication_BindsOptionsWithoutOwningIdentityAdapters() {
        ...
        Assert.Multiple(
            ...
            () => Assert.True(File.Exists(ArchitectureTestPaths.FromRoot("Platform/tests/FoodDiary.Infrastructure.Tests/Authentication/JwtOptionsTests.cs"))));
    }
