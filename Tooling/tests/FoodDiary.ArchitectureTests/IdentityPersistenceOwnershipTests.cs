...
public sealed class IdentityPersistenceOwnershipTests {
    ...
    [InlineData("Platform/tests/FoodDiary.Infrastructure.Tests/Services/EmailTemplateProviderTests.cs", "Modules/Identity/tests/FoodDiary.Modules.Identity.Infrastructure.Tests/EmailTemplateProviderTests.cs")]
    [InlineData("Platform/tests/FoodDiary.Infrastructure.IntegrationTests/Integration/UserLoginEventRepositoryIntegrationTests.cs", "Modules/Identity/tests/FoodDiary.Modules.Identity.Infrastructure.IntegrationTests/Integration/UserLoginEventRepositoryIntegrationTests.cs")]
    ...
    [InlineData("FoodDiary.Infrastructure/Persistence/Authentication/ConsumedTelegramAssertion.cs", "Modules/Identity/PersistenceModel/Authentication/ConsumedTelegramAssertion.cs")]
    [InlineData("FoodDiary.Infrastructure/Persistence/Configurations/Authentication/ConsumedTelegramAssertionConfiguration.cs", "Modules/Identity/PersistenceModel/Configurations/Authentication/ConsumedTelegramAssertionConfiguration.cs")]
    ...
    public void TelegramReplayProviderTests_StayWithIdentityInsteadOfMixedDietologistCoverage() {
        ...
        string donor = File.ReadAllText(ArchitectureTestPaths.FromRoot("Platform/tests/FoodDiary.Infrastructure.IntegrationTests/Integration/DietologistPersistenceIntegrationTests.cs"));
