...
public sealed class ExportModuleExtractionTests {
    ...
    public void ExportApplicationSource_LivesOnlyInExtractedAssembly() {
        string legacyRoot = ArchitectureTestPaths.FromRoot("FoodDiary.Modules.Export.Application");
    ...
    public void ExtractedExportAssembly_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Application.Contracts", "FoodDiary.Authentication.Contracts", "FoodDiary.Mediator", "FoodDiary.Modules.Cycles.Contracts", "FoodDiary.Modules.Cycles.Domain.Contracts", "FoodDiary.Modules.Export.Application.Abstractions", "FoodDiary.Modules.Meals.Contracts", "FoodDiary.Modules.Meals.Domain.Contracts", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain.Contracts"], references);
    }
    ...
    public void ExportPdfTests_LiveWithTheirAdapter() {
        Assert.False(File.Exists(ArchitectureTestPaths.FromRoot(
            "Platform", "tests", "FoodDiary.Infrastructure.Tests", "Services", "DiaryPdfGeneratorTests.cs")));
