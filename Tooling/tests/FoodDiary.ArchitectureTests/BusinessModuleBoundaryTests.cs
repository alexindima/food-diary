...
public sealed class BusinessModuleBoundaryTests {
    ...
    public void ExtractedModuleOwnedTests_DoNotReturnToHorizontalDonorProjects() {
        ...
        string[] infrastructureTestRoots = [
            ArchitectureTestPaths.FromRoot("Platform", "tests", "FoodDiary.Infrastructure.Tests"),
            ArchitectureTestPaths.FromRoot("Platform", "tests", "FoodDiary.Infrastructure.IntegrationTests"),
        ];
    ...
    public void MigratedAuthenticationIdentityHandlers_DoNotDependOnUsersAggregateAccess() {
        ...
        string[] forbiddenReferences = [
            "FoodDiary.Modules.Users.Domain.Entities",
    ...
    public void OtherApplicationModules_DoNotReferenceInternalUsersNamespace() {
        ...
        string[] violations = [.. ModuleSourceCatalog.ApplicationFiles()
            ...
            .SelectMany(path => File.ReadLines(path)
                .Select((line, index) => new { path, line, index }))
            .Where(static entry => !entry.line.Contains("InternalsVisibleTo(", StringComparison.Ordinal) &&
                (entry.line.Contains("FoodDiary.Application.Users.", StringComparison.Ordinal) ||
                 entry.line.Contains("FoodDiary.Modules.Users.Application.", StringComparison.Ordinal)))
    ...
    public void IdentityConfigurations_StayInOwnedFolders(
        ...
        string expectedPath = string.Equals(expectedRelativeDirectory, "Configurations/Users", StringComparison.Ordinal)
            ? ArchitectureTestPaths.FromRoot("Modules", "Users", "PersistenceModel", "Persistence", "Configurations", "Users", fileName)
            : ArchitectureTestPaths.FromRoot("Modules", "Identity", "PersistenceModel", "Configurations", "Authentication", fileName);
    ...
    [InlineData("WearableConnectionConfiguration.cs", "Modules/Wearables/PersistenceModel/Configurations/Wearables")]
    [InlineData("WearableSyncEntryConfiguration.cs", "Modules/Wearables/PersistenceModel/Configurations/Wearables")]
