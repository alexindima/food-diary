...
public sealed class DependencyInjectionTests {
    ...
    public void AddIntegrations_WithInvalidMailRelayClientBaseUrl_FailsOptionsValidation() {
        ...
        services.AddIntegrations(configuration).AddIdentityProvider(configuration).AddImagesProvider(configuration).AddAiProvider(configuration).AddUsdaProvider(configuration).AddOpenFoodFactsProvider(configuration).AddWearablesProvider(configuration).AddNotificationsProvider(configuration);
        using ServiceProvider provider = services.BuildServiceProvider();
    ...
    public void AddIntegrations_WithInvalidS3ServiceUrl_FailsOptionsValidation() {
        ...
        OptionsValidationException ex = Assert.Throws<OptionsValidationException>(() => provider.GetRequiredService<IOptions<FoodDiary.Modules.Images.Infrastructure.Providers.Options.S3Options>>().Value);
    ...
    public async Task AddIntegrations_SensitiveQueryClients_DoNotUseDefaultHttpClientLogging(string clientName) {
        ...
        services.AddSingleton(TimeProvider.System);
        services.AddIntegrations(CreateValidIntegrationsConfiguration()).AddIdentityProvider(CreateValidIntegrationsConfiguration()).AddImagesProvider(CreateValidIntegrationsConfiguration()).AddAiProvider(CreateValidIntegrationsConfiguration()).AddUsdaProvider(CreateValidIntegrationsConfiguration()).AddOpenFoodFactsProvider(CreateValidIntegrationsConfiguration()).AddWearablesProvider(CreateValidIntegrationsConfiguration()).AddNotificationsProvider(CreateValidIntegrationsConfiguration());
    ...
    [Fact]
    public void AddInfrastructureAndHydrationModule_TrackingRepositoriesResolveThroughScopedConcreteInstances() {
        var services = new ServiceCollection();
        services.AddSingleton(Substitute.For<IPublisher>());
        IConfiguration configuration = CreateConfiguration(new Dictionary<string, string?>(StringComparer.Ordinal) {
            ["ConnectionStrings:DefaultConnection"] = "Host=localhost;Database=food_diary;Username=test;Password=test",
        ...
        Assert.IsType<FoodDiary.Modules.Hydration.Infrastructure.Persistence.HydrationIntervalReadService>(
            scope.ServiceProvider.GetRequiredService<FoodDiary.Modules.Hydration.Application.Abstractions.Common.IHydrationIntervalReadModelRepository>());
    ...
    public void AddInfrastructureAndFeatureModules_SplitRepositoriesResolveThroughSameScopedInstance(string primaryTypeName, string[] aliasTypeNames) {
        var services = new ServiceCollection();
        services.AddSingleton(Substitute.For<IPublisher>());
        IConfiguration configuration = CreateConfiguration(new Dictionary<string, string?>(StringComparer.Ordinal) {
            ["ConnectionStrings:DefaultConnection"] = "Host=localhost;Database=food_diary;Username=test;Password=test",
    ...
    public static TheoryData<string, string[]> SplitRepositoryRegistrationCases() => new() {
        ...
        {
            "FoodDiary.Modules.Usda.Application.Abstractions.Common.IUsdaFoodRepository",
            [
                "FoodDiary.Modules.Usda.Application.Abstractions.Common.IUsdaFoodReadRepository",
                "FoodDiary.Modules.Usda.Application.Abstractions.Common.IUsdaFoodReadModelRepository",
            ]
        },
        {
        ...
        {
            "FoodDiary.Modules.Lessons.Application.Abstractions.Common.INutritionLessonRepository",
            [
                "FoodDiary.Modules.Lessons.Application.Abstractions.Common.INutritionLessonReadRepository",
                "FoodDiary.Modules.Lessons.Application.Abstractions.Common.INutritionLessonReadModelRepository",
                "FoodDiary.Modules.Lessons.Application.Abstractions.Common.INutritionLessonWriteRepository",
            ]
        },
        {
        ...
        {
            "FoodDiary.Modules.Wearables.Application.Abstractions.Common.IWearableConnectionRepository",
            [
                "FoodDiary.Modules.Wearables.Application.Abstractions.Common.IWearableConnectionReadRepository",
                "FoodDiary.Modules.Wearables.Application.Abstractions.Common.IWearableConnectionWriteRepository",
            ]
        },
        {
            "FoodDiary.Modules.Wearables.Application.Abstractions.Common.IWearableSyncRepository",
            [
                "FoodDiary.Modules.Wearables.Application.Abstractions.Common.IWearableSyncReadRepository",
                "FoodDiary.Modules.Wearables.Application.Abstractions.Common.IWearableSyncReadModelRepository",
                "FoodDiary.Modules.Wearables.Application.Abstractions.Common.IWearableSyncWriteRepository",
            ]
        },
        {
        ...
        {
            "FoodDiary.Modules.Users.Application.Abstractions.Common.IUserRepository",
            [
                "FoodDiary.Modules.Users.Application.Abstractions.Common.IUserLookupRepository",
                "FoodDiary.Modules.Users.Application.Abstractions.Common.IUserGoogleIdentityRepository",
                "FoodDiary.Modules.Users.Application.Abstractions.Common.IUserWriteRepository",
            ]
        },
    };
    ...
    private static IEnumerable<Type> GetUserOwnedEntityTypes() {
        return typeof(AiUsage).Assembly
            .GetTypes()
            .Concat(typeof(FoodDiary.Modules.Users.Domain.Entities.User).Assembly.GetTypes())
            .Where(type =>
