...
| ---------------------------------- | ------------------- | --- | --- | ----------------------------------------------------------------------------------------------------------- |
| `/`                                | main public landing | yes | yes | No overflow; auth redirect briefly renders the landing before `/dashboard` and needs a separate routing fix |
...
| Surface               | D   | M               | Notes                                                                            |
| --------------------- | --- | --------------- | -------------------------------------------------------------------------------- |
| Login/register dialog | yes | previous review | Uses shared dialog; Russian labels and Google unavailable state render correctly |
| `/mobile/login`       | -   | -               | Pending standalone mobile flow review                                            |
| `/verify-pending`     | -   | -               | Pending                                                                          |
| `/verify-email`       | -   | -               | Pending success/error states                                                     |
| `/reset-password`     | -   | -               | Pending validation/error states                                                  |
...
| P2       | Authenticated navigation to `/` briefly renders the public landing before redirecting     | Open; route/auth readiness ownership                                      |
