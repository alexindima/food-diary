...
See [AI development reliability](architecture/ai-development-reliability.md) for executable failure-handling rules, transaction ownership, guardrail negative tests and the provider-level evidence map.
