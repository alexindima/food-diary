...
AI PersistenceModel uses only its own Domain, Users.Domain.Contracts and the ID-only Images.Contracts. It no longer references Users.Domain or Images.Domain.
