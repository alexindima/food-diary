...
Wiki omissions verified against source: domain invariant and mixed Tracking tests, relational flow, internal DomainGuard/IVT, central Errors facade. No source changes yet.
