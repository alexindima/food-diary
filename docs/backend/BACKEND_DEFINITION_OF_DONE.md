...
Date: 2026-03-28
Scope: backend changes in `Modules/*`, shared contract/primitives projects under `Shared/`, `FoodDiary.Application.Runtime`, `FoodDiary.Infrastructure`, `FoodDiary.Presentation.Api`, `FoodDiary.Web.Api`, and related backend tests
