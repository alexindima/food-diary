...
public sealed class SmtpEmailSenderTests {
    ...
    public async Task SendPasswordResetAsync_WhenTransportFails_RecordsFailureMetric() {
        ...
        var sender = CreateSender(new ThrowingEmailTransport(new SmtpException("boom")));
        ...
        Assert.Equal(nameof(SmtpException), errorType);
    }

    private static SmtpEmailSender CreateSender(IEmailTransport transport) {
