...
public sealed class TdeeModuleExtractionTests {
    ...
    public void TdeeApplicationAssembly_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Application.Abstractions", "FoodDiary.Mediator", "FoodDiary.Modules.BodyMetrics.Application.Abstractions", "FoodDiary.Modules.Dashboard.Contracts", "FoodDiary.Modules.Exercises.Contracts", "FoodDiary.Modules.Users.Domain.Contracts"], references);
    }
