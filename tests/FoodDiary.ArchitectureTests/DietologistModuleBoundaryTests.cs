...
public sealed class DietologistModuleBoundaryTests {
    ...
    public void ExtractedDietologistAssembly_HasOnlyApprovedProjectReferences() {
        ...
        string[] expectedReferences = ["FoodDiary.Application.Abstractions", "FoodDiary.Mediator", "FoodDiary.Modules.Dietologist.Application.Abstractions", "FoodDiary.Modules.Dietologist.Domain", "FoodDiary.Modules.Users.Domain", "FoodDiary.Modules.Users.Domain.Contracts"];
