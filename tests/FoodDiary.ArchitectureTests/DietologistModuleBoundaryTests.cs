...
public sealed class DietologistModuleBoundaryTests {
    ...
    public void ExtractedDietologistAssembly_HasOnlyApprovedProjectReferences() {
        ...
        string[] expectedReferences = ["FoodDiary.Application.Contracts", "FoodDiary.Audit.Contracts", "FoodDiary.Authentication.Contracts", "FoodDiary.Email.Contracts", "FoodDiary.Mediator", "FoodDiary.Modules.Dietologist.Application.Abstractions", "FoodDiary.Modules.Dietologist.Domain", "FoodDiary.Modules.Identity.Contracts", "FoodDiary.Modules.Notifications.Contracts", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain.Contracts"];
