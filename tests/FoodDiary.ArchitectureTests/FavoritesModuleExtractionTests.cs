...
public sealed class FavoritesModuleExtractionTests {
    ...
    public void ExtractedFavoritesAssembly_HasOnlyApprovedProjectReferences() {
        ...
        string[] expectedReferences = ["FoodDiary.Application.Abstractions", "FoodDiary.Domain", "FoodDiary.Mediator", "FoodDiary.Modules.Favorites.Domain", "FoodDiary.Modules.Meals.Contracts", "FoodDiary.Modules.Users.Domain.Contracts"];
