...
public sealed class ProjectDependencyMatrixTests {
    ...
    private static readonly IReadOnlyDictionary<string, string[]> AllowedProductionProjectReferences =
        new Dictionary<string, string[]>(StringComparer.Ordinal) {
            ["FoodDiary.Modules.Images.Service.Contracts"] = ["FoodDiary.Modules.Images.Contracts", "FoodDiary.Modules.Users.Domain.Contracts", "FoodDiary.Results"],
            ["FoodDiary.Analyzers"] = [],
