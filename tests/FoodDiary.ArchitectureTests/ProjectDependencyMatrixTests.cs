...
public sealed class ProjectDependencyMatrixTests {
    ...
    private static readonly IReadOnlyDictionary<string, string[]> AllowedTestProjectReferences =
        new Dictionary<string, string[]>(StringComparer.Ordinal) {
            ...
            ["FoodDiary.Modules.Usda.Application.Tests"] = ["FoodDiary.Modules.Products.Application", "FoodDiary.Application.Usda"],
            ...
            ["FoodDiary.Modules.Favorites.Application.Tests"] = ["FoodDiary.Application.Favorites", "FoodDiary.Modules.Recipes.Application"],
