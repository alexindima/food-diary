...
public sealed class NotificationsModuleExtractionTests {
    ...
    public void ExtractedNotificationsAssembly_HasOnlyApprovedProjectReferences() {
        ...
        string[] expectedReferences = ["FoodDiary.Application.Abstractions", "FoodDiary.Domain", "FoodDiary.Mediator", "FoodDiary.Modules.Notifications.Application.Abstractions", "FoodDiary.Modules.Notifications.Domain", "FoodDiary.Modules.Users.Domain"];
