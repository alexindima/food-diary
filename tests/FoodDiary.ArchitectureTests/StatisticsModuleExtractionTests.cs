...
public sealed class StatisticsModuleExtractionTests {
    ...
    public void ExtractedStatisticsAssembly_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Application.Contracts", "FoodDiary.Mediator", "FoodDiary.Modules.BodyMetrics.Contracts", "FoodDiary.Modules.Dashboard.Contracts", "FoodDiary.Modules.Hydration.Contracts", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain.Contracts"], references);
    }
