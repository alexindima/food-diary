...
public sealed class RetiredDomainAssemblyTests {
    ...
    [InlineData(typeof(FoodDiary.Application.Abstractions.Ai.Common.IAiAdministrationReadService), "FoodDiary.Modules.Ai.Contracts")]
    [InlineData(typeof(FoodDiary.Application.Abstractions.Ai.Common.IAiPromptAdministrationService), "FoodDiary.Modules.Ai.Contracts")]
    [InlineData(typeof(FoodDiary.Application.Abstractions.Ai.Common.IFoodRecognitionResultReader), "FoodDiary.Modules.Ai.Contracts")]
