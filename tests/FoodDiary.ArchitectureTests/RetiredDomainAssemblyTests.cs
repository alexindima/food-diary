...
public sealed class RetiredDomainAssemblyTests {
    ...
    [InlineData(typeof(FoodDiary.Modules.Ai.Contracts.Common.IAiAdministrationReadService), "FoodDiary.Modules.Ai.Contracts")]
    [InlineData(typeof(FoodDiary.Modules.Ai.Contracts.Common.IAiPromptAdministrationService), "FoodDiary.Modules.Ai.Contracts")]
    [InlineData(typeof(FoodDiary.Modules.Ai.Contracts.Common.IFoodRecognitionResultReader), "FoodDiary.Modules.Ai.Contracts")]
    ...
    [InlineData(typeof(FoodDiary.Modules.BodyMetrics.Contracts.WeightEntries.Common.IWeightEntryReadService), "FoodDiary.Modules.BodyMetrics.Contracts")]
    [InlineData(typeof(FoodDiary.Modules.BodyMetrics.Contracts.WaistEntries.Common.IWaistEntryReadService), "FoodDiary.Modules.BodyMetrics.Contracts")]
