...
Hydration, RecentItems, Exercises and WeeklyGoals use the same scalar persistence boundary as AI: owned mappings stay local, typed User Cascade FKs live under Persistence/Composition and are installed after module registrations. ScalarPersistenceBoundaryTests and the exact matrix prohibit foreign Domain dependencies in these five models. Preserve schema and lifecycle behavior; see docs/ai/scalar-persistence-boundaries.md.
