...
public sealed class GamificationModuleExtractionTests {
    ...
    public void ExtractedGamificationAssembly_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Application.Contracts", "FoodDiary.Mediator", "FoodDiary.Modules.Gamification.Application.Abstractions", "FoodDiary.Modules.Gamification.Contracts", "FoodDiary.Modules.Gamification.Domain", "FoodDiary.Modules.Gamification.Domain.Contracts", "FoodDiary.Modules.Meals.Contracts", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain.Contracts"], references);
    }
