...
public sealed class DashboardModuleExtractionTests {
    ...
    public void ExtractedDashboardAssembly_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Application.Abstractions", "FoodDiary.Application.Cycles", "FoodDiary.Mediator", "FoodDiary.Modules.BodyMetrics.Application.Abstractions", "FoodDiary.Modules.DailyAdvices.Application", "FoodDiary.Modules.Dashboard.Application.Abstractions", "FoodDiary.Modules.Dashboard.Contracts", "FoodDiary.Modules.Dietologist.Application.Abstractions", "FoodDiary.Modules.Exercises.Contracts", "FoodDiary.Modules.Fasting.Contracts", "FoodDiary.Modules.Hydration.Contracts", "FoodDiary.Modules.Identity.Application.Abstractions", "FoodDiary.Modules.Meals.Application", "FoodDiary.Modules.Products.Domain", "FoodDiary.Modules.Products.Domain.Contracts", "FoodDiary.Modules.Statistics.Application", "FoodDiary.Modules.Tdee.Application", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain"], references);
    }
