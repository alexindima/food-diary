...
public sealed class JobManagerGuardrailTests {
    ...
    public void JobManagerProject_ReferencesOnlyApprovedRuntimeModulesAndSchedulerPackages() {
        ...
        string[] expectedProjectReferences = ["FoodDiary.Modules.Exercises.Application", "FoodDiary.Application.Images", "FoodDiary.Application.MealPlanning", "FoodDiary.Application.Notifications", "FoodDiary.Application.RecipeCommunity", "FoodDiary.Application.Runtime", "FoodDiary.Application.Usda", "FoodDiary.Email.Contracts", "FoodDiary.Email.MailRelay", "FoodDiary.Infrastructure", "FoodDiary.Mediator", "FoodDiary.Modules.Admin.Infrastructure", "FoodDiary.Modules.Ai.Contracts", "FoodDiary.Modules.Ai.Infrastructure", "FoodDiary.Modules.Billing.Contracts", "FoodDiary.Modules.Billing.Infrastructure", "FoodDiary.Modules.BodyMetrics.Application", "FoodDiary.Modules.DailyAdvices.Application", "FoodDiary.Modules.Dashboard.Application", "FoodDiary.Modules.Dashboard.Infrastructure", "FoodDiary.Modules.Dietologist.Contracts", "FoodDiary.Modules.Dietologist.Infrastructure", "FoodDiary.Modules.Export.Application", "FoodDiary.Modules.Export.Infrastructure", "FoodDiary.Modules.Fasting.Contracts", "FoodDiary.Modules.Fasting.Infrastructure", "FoodDiary.Modules.Favorites.Infrastructure", "FoodDiary.Modules.Gamification.Infrastructure", "FoodDiary.Modules.Identity.Application", "FoodDiary.Modules.Identity.Application.Abstractions", "FoodDiary.Modules.Identity.Infrastructure", "FoodDiary.Modules.Images.Application.Abstractions", "FoodDiary.Modules.Images.Infrastructure", "FoodDiary.Modules.Images.Service.Contracts", "FoodDiary.Modules.Marketing.Infrastructure", "FoodDiary.Modules.Meals.Infrastructure", "FoodDiary.Modules.Notifications.Application.Abstractions", "FoodDiary.Modules.Notifications.Infrastructure", "FoodDiary.Modules.OpenFoodFacts.Application", "FoodDiary.Modules.OpenFoodFacts.Infrastructure", "FoodDiary.Modules.Products.Application", "FoodDiary.Modules.Products.Infrastructure", "FoodDiary.Modules.RecentItems.Infrastructure", "FoodDiary.Modules.Recipes.Application", "FoodDiary.Modules.Recipes.Infrastructure", "FoodDiary.Modules.Statistics.Application", "FoodDiary.Modules.Tdee.Application", "FoodDiary.Modules.Usda.Infrastructure", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Infrastructure", "FoodDiary.Modules.Wearables.Infrastructure", "FoodDiary.Modules.WeeklyGoals.Application", "FoodDiary.Modules.WeeklyGoals.Infrastructure", "FoodDiary.ReadModel.Composition"];
    ...
    [Fact]
    public void JobManagerSource_DoesNotOwnPersistenceOrApplicationHandlers() {
        string jobManagerRoot = ArchitectureTestPaths.FromRoot("FoodDiary.JobManager");
