...
public sealed class AdminModuleExtractionTests {
    ...
    public void ExtractedAdminAssembly_HasOnlyApprovedProjectReferences() {
        ...
        Assert.Equal(["FoodDiary.Application.Contracts", "FoodDiary.Audit.Contracts", "FoodDiary.Authentication.Contracts", "FoodDiary.Email.Contracts", "FoodDiary.Mediator", "FoodDiary.Modules.Admin.Application.Abstractions", "FoodDiary.Modules.Admin.Contracts", "FoodDiary.Modules.Ai.Application.Abstractions", "FoodDiary.Modules.Billing.Domain.Contracts", "FoodDiary.Modules.ContentReports.Contracts", "FoodDiary.Modules.ContentReports.Domain.Contracts", "FoodDiary.Modules.Gamification.Contracts", "FoodDiary.Modules.Gamification.Domain.Contracts", "FoodDiary.Modules.Identity.Application.Abstractions", "FoodDiary.Modules.Lessons.Contracts", "FoodDiary.Modules.Lessons.Domain.Contracts", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain.Contracts"], references);
    }
