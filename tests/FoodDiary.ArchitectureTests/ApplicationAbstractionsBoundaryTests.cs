...
public sealed class ApplicationAbstractionsBoundaryTests {
    ...
    public void ApplicationAbstractionsProject_StaysDependencyLightweight() {
        ...
        Assert.Equal(["FoodDiary.Domain.Primitives", "FoodDiary.Mediator", "FoodDiary.Modules.Admin.Application.Abstractions", "FoodDiary.Modules.Ai.Application.Abstractions", "FoodDiary.Modules.BodyMetrics.Application.Abstractions", "FoodDiary.Modules.Cycles.Application.Abstractions", "FoodDiary.Modules.DailyAdvices.Application.Abstractions", "FoodDiary.Modules.Dietologist.Application.Abstractions", "FoodDiary.Modules.Exercises.Application.Abstractions", "FoodDiary.Modules.Fasting.Application.Abstractions", "FoodDiary.Modules.Favorites.Application.Abstractions", "FoodDiary.Modules.Hydration.Application.Abstractions", "FoodDiary.Modules.Images.Application.Abstractions", "FoodDiary.Modules.MealPlanning.Application.Abstractions", "FoodDiary.Modules.Meals.Application.Abstractions", "FoodDiary.Modules.Products.Application.Abstractions", "FoodDiary.Modules.RecipeCommunity.Application.Abstractions", "FoodDiary.Modules.Recipes.Application.Abstractions", "FoodDiary.Modules.Usda.Application.Abstractions", "FoodDiary.Modules.Users.Contracts", "FoodDiary.Modules.Users.Domain.Contracts", "FoodDiary.Modules.Wearables.Application.Abstractions", "FoodDiary.Results"], projectReferences);
