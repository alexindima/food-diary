...
public sealed class ApplicationAbstractionsBoundaryTests {
    ...
    public void ApplicationAbstractionsProject_StaysDependencyLightweight() {
        ...
        Assert.Equal(["FoodDiary.Domain", "FoodDiary.Domain.Primitives", "FoodDiary.Mediator", "FoodDiary.Modules.Cycles.Application.Abstractions", "FoodDiary.Modules.Favorites.Domain", "FoodDiary.Modules.Images.Application.Abstractions", "FoodDiary.Results"], projectReferences);
