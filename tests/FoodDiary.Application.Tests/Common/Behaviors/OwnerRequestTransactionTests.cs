...
namespace FoodDiary.Application.Tests.Common.Behaviors;
...
public sealed class OwnerRequestTransactionTests {
    ...
    public async Task NestedPromptMutation_LeavesCommitAndPostCommitActionsToOuterCommand(bool failAfterMutation) {
        ...
        services.AddFoodDiaryMediator(configuration => configuration.AddOpenBehavior(typeof(CommandTransactionBehavior<,>)));
