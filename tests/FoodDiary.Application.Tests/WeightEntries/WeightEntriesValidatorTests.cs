...
public class WeightEntriesValidatorTests {
    ...
    public async Task DeleteWeight_WithEmptyEntryId_HasError() {
        TestValidationResult<DeleteWeightEntryCommand> result = await new DeleteWeightEntryCommandValidator().TestValidateAsync(
    ...
    public async Task GetWeightSummaries_WithZeroQuantization_HasError() {
        TestValidationResult<GetWeightSummariesQuery> result = await new GetWeightSummariesQueryValidator().TestValidateAsync(
