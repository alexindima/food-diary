...
using ExportUtcDateNormalizer = FoodDiary.Modules.Export.Application.Internal.UtcDateNormalizer;
using HydrationUtcDateNormalizer = FoodDiary.Modules.Hydration.Application.Internal.UtcDateNormalizer;
