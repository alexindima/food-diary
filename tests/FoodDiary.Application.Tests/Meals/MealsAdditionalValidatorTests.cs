...
public class MealsAdditionalValidatorTests {
    ...
    // â”€â”€ MealItemValidator â”€â”€

    [Fact]
    public void MealItem_WithNoProductOrRecipe_ReturnsFailure() {
        var item = new MealItemInput(ProductId: null, RecipeId: null, 100);
        Result result = MealItemValidator.Validate(item);
        ResultAssert.Failure(result);
    }

    [Fact]
    public void MealItem_WithBothProductAndRecipe_ReturnsFailure() {
        var item = new MealItemInput(Guid.NewGuid(), Guid.NewGuid(), 100);
        Result result = MealItemValidator.Validate(item);
        ResultAssert.Failure(result);
    }

    [Fact]
    public void MealItem_WithZeroAmount_ReturnsFailure() {
        var item = new MealItemInput(Guid.NewGuid(), RecipeId: null, 0);
        Result result = MealItemValidator.Validate(item);
        ResultAssert.Failure(result);
    }
    ...
    public void MealItem_WithNonFiniteAmount_ReturnsFailure(double amount) {
        var item = new MealItemInput(Guid.NewGuid(), RecipeId: null, amount);
    ...
    [Fact]
    public void MealItem_WithTooLargeAmount_ReturnsFailure() {
        var item = new MealItemInput(Guid.NewGuid(), RecipeId: null, 1_000_000.01d);
    ...
    [Fact]
    public void MealItem_WithValidProductAndAmount_ReturnsSuccess() {
        var item = new MealItemInput(Guid.NewGuid(), RecipeId: null, 150);
        Result result = MealItemValidator.Validate(item);
