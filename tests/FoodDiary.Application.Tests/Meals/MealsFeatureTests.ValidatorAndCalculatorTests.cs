...
public partial class MealsFeatureTests {
    ...
    [Fact]
    public void MealItemValidator_WhenIdsAreMissing_Fails() {
        Result result = MealItemValidator.Validate(new MealItemInput(ProductId: null, RecipeId: null, 100));
    ...
    public void MealNutritionCalculator_WhenMealHasProductRecipeAndAiItems_CalculatesCombinedTotals() {
        ...
        MealNutritionSummary result = MealNutritionCalculator.Calculate(
            ...
            new Dictionary<RecipeId, RecipeOverviewReadItem> { [recipe.Id] = TestRecipeOverview.From(recipe, userId) });
    ...
    public void MealNutritionCalculator_WhenRecipeItemIsMissingFromLookup_IgnoresRecipeItem() {
        ...
        MealNutritionSummary result = MealNutritionCalculator.Calculate(
            ...
            new Dictionary<RecipeId, RecipeOverviewReadItem>());
