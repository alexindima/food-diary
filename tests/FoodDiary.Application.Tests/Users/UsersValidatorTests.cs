...
public class UsersValidatorTests {
    ...
    public async Task UpdateUser_WithNullUserId_HasError() {
        ...
        var result = await v.TestValidateAsync(new UpdateUserCommand(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null));
        result.ShouldHaveValidationErrorFor(c => c.UserId);
    }
    ...
    public async Task UpdateUser_WithNegativeWeight_HasError() {
        var v = new UpdateUserCommandValidator();
        var result = await v.TestValidateAsync(new UpdateUserCommand(Guid.NewGuid(), null, null, null, null, null, -1, null, null, null, null, null, null, null, null, null, null, null, null, null));
