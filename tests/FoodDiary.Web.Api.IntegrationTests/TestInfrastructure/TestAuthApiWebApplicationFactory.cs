    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder) {
        ...
        builder.ConfigureAppConfiguration((_, configBuilder) => {
            configBuilder.AddInMemoryCollection(new Dictionary<string, string?>(StringComparer.Ordinal) {
                ...
                ["Stripe:SecretKey"] = "sk_test_codex", ["Stripe:PublishableKey"] = "pk_test_codex",
                ["Stripe:WebhookSecret"] = "whsec_codex", ["Stripe:PremiumMonthlyPriceId"] = "price_monthly_codex",
                ...
                ["Paddle:ApiKey"] = "", ["Paddle:ClientSideToken"] = "", ["Paddle:WebhookSecretKey"] = "", ["Paddle:NotificationSettingId"] = "", ["Paddle:PremiumMonthlyPriceId"] = "", ["Paddle:PremiumYearlyPriceId"] = "",
                ["YooKassa:ShopId"] = "", ["YooKassa:SecretKey"] = "", ["YooKassa:PremiumMonthlyAmount"] = "", ["YooKassa:PremiumYearlyAmount"] = "",
                ["RateLimiting:Auth:PermitLimit"] = "1000", ["RateLimiting:Auth:WindowSeconds"] = "60",
                ["RateLimiting:Ai:PermitLimit"] = "1000", ["RateLimiting:Ai:WindowSeconds"] = "60",
                ["RateLimiting:TestDelivery:PermitLimit"] = "1000", ["RateLimiting:TestDelivery:WindowSeconds"] = "60",
                ["RateLimiting:FoodData:PermitLimit"] = "1000", ["RateLimiting:FoodData:WindowSeconds"] = "60",
                ["RateLimiting:SecretVerification:PermitLimit"] = "1000", ["RateLimiting:SecretVerification:WindowSeconds"] = "60",
                ["RateLimiting:Billing:PermitLimit"] = "1000", ["RateLimiting:Billing:WindowSeconds"] = "60",
                ["RateLimiting:Export:PermitLimit"] = "1000", ["RateLimiting:Export:WindowSeconds"] = "60",
            });
        });
