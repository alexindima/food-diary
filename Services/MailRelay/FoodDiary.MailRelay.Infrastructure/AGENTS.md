...
## Scope
Rules for `Services/MailRelay/FoodDiary.MailRelay.Infrastructure/`.
...
- Depend on `Services/MailRelay/FoodDiary.MailRelay.Application`; do not reference MailRelay presentation or host projects.
...
## Commands
- Build: `dotnet build Services/MailRelay/FoodDiary.MailRelay.Infrastructure/FoodDiary.MailRelay.Infrastructure.csproj`
