...
## Scope
Rules for `Services/MailRelay/FoodDiary.MailRelay.Initializer/`.
...
## Commands
- Build: `dotnet build Services/MailRelay/FoodDiary.MailRelay.Initializer/FoodDiary.MailRelay.Initializer.csproj`
- Status: `dotnet run --project Services/MailRelay/FoodDiary.MailRelay.Initializer -- status`
- Update schema: `dotnet run --project Services/MailRelay/FoodDiary.MailRelay.Initializer -- update`
