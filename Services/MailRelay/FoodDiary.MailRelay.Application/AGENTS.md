...
## Scope
Rules for `Services/MailRelay/FoodDiary.MailRelay.Application/`.
...
- Depend only on `Services/MailRelay/FoodDiary.MailRelay.Domain`, `Shared/FoodDiary.Results`, and `Shared/FoodDiary.Mediator` among local production projects.
...
## Commands
- Build: `dotnet build Services/MailRelay/FoodDiary.MailRelay.Application/FoodDiary.MailRelay.Application.csproj`
- Tests: `dotnet test Services/MailRelay/tests/FoodDiary.MailRelay.Application.Tests/FoodDiary.MailRelay.Application.Tests.csproj`
