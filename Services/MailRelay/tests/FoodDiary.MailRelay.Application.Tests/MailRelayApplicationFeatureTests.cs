...
using FoodDiary.MailRelay.Application.Emails.Queries.GetMailRelayDeliveryEvents;
using FoodDiary.MailRelay.Application.Emails.Queries.GetMailRelayMessageDetails;
