...
## Scope
Rules for `Services/MailRelay/FoodDiary.MailRelay.WebApi/`.
...
- Keep HTTP endpoints in `Services/MailRelay/FoodDiary.MailRelay.Presentation`.
- Keep domain concepts in `Services/MailRelay/FoodDiary.MailRelay.Domain`.
- Keep relay use cases and abstractions in `Services/MailRelay/FoodDiary.MailRelay.Application`.
- Keep PostgreSQL, RabbitMQ, SMTP, direct-to-MX, DNS, DKIM, hosted workers, and DI registration in `Services/MailRelay/FoodDiary.MailRelay.Infrastructure`.
...
- Use MVC controller mapping from `Services/MailRelay/FoodDiary.MailRelay.Presentation`; do not add minimal API `/api/email` endpoints in `Program.cs`.
...
## Commands
- Build: `dotnet build Services/MailRelay/FoodDiary.MailRelay.WebApi/FoodDiary.MailRelay.WebApi.csproj`
- Run: `dotnet run --project Services/MailRelay/FoodDiary.MailRelay.WebApi`
- Tests: `dotnet test Services/MailRelay/tests/FoodDiary.MailRelay.IntegrationTests/FoodDiary.MailRelay.IntegrationTests.csproj`
