...
## Scope
Rules for `Services/MailRelay/FoodDiary.MailRelay.Presentation/`.
...
- Do not reference `Services/MailRelay/FoodDiary.MailRelay.Infrastructure`.
- May reference `Services/MailRelay/FoodDiary.MailRelay.Application` and `Services/MailRelay/FoodDiary.MailRelay.Client`.
- Do not reference `Services/MailRelay/FoodDiary.MailRelay.WebApi`.
...
## Commands
- Build: `dotnet build Services/MailRelay/FoodDiary.MailRelay.Presentation/FoodDiary.MailRelay.Presentation.csproj`
