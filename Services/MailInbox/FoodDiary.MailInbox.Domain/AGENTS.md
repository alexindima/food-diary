...
## Scope
Rules for `Services/MailInbox/FoodDiary.MailInbox.Domain/`.
...
## Commands
- Build: `dotnet build Services/MailInbox/FoodDiary.MailInbox.Domain/FoodDiary.MailInbox.Domain.csproj`
