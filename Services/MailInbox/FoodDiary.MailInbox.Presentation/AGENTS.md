...
## Scope
Rules for `Services/MailInbox/FoodDiary.MailInbox.Presentation/`.
...
- May reference `Services/MailInbox/FoodDiary.MailInbox.Application`; do not reference infrastructure or host projects.
...
## Commands
- Build: `dotnet build Services/MailInbox/FoodDiary.MailInbox.Presentation/FoodDiary.MailInbox.Presentation.csproj`
