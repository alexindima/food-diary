...
## Scope
Rules for `Services/MailInbox/FoodDiary.MailInbox.Initializer/`.
...
## Architecture
- Keep persistence mappings and migrations in `Services/MailInbox/FoodDiary.MailInbox.Infrastructure`.
...
## Commands
- Build: `dotnet build Services/MailInbox/FoodDiary.MailInbox.Initializer/FoodDiary.MailInbox.Initializer.csproj`
