...
if (string.IsNullOrWhiteSpace(connectionString)) {
    Console.Error.WriteLine(
        "MailInbox initializer failed: DefaultConnection is not configured. Set ConnectionStrings__DefaultConnection, set FOODDIARY_ConnectionStrings__DefaultConnection, set MAILINBOX_ConnectionStrings__DefaultConnection, use development user secrets, or provide appsettings in Services/MailInbox/FoodDiary.MailInbox.WebApi.");
    return 1;
}
...
static void PrintUsage() {
    Console.WriteLine("""
Usage:
  dotnet run --project Services/MailInbox/FoodDiary.MailInbox.Initializer -- <command>
...
Examples:
  dotnet run --project Services/MailInbox/FoodDiary.MailInbox.Initializer -- status
  dotnet run --project Services/MailInbox/FoodDiary.MailInbox.Initializer -- update
