...
- Depend on `FoodDiary.MailInbox.Application`; do not reference MailInbox presentation or host projects.
...
## Commands
- Build: `dotnet build FoodDiary.MailInbox.Infrastructure/FoodDiary.MailInbox.Infrastructure.csproj`
