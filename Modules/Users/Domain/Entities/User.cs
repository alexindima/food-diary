...
using DesiredWeightValueObject = FoodDiary.Modules.Users.Domain.Contracts.ValueObjects.DesiredWeightKg;
using ProfileHeightValueObject = FoodDiary.Modules.Users.Domain.ValueObjects.ProfileHeightCm;
using ProfileWeightValueObject = FoodDiary.Modules.Users.Domain.ValueObjects.ProfileWeightKg;
...
public sealed partial class User : AggregateRoot<UserId> {
    ...
    public double? GetCalorieTargetForDate(DateTime date) {
        return GetCalorieSchedule().GetTargetForDate(date);
    }

    public double GetWeeklyCalorieTarget() {
        return GetCalorieSchedule().GetWeeklyTarget();
    }
    ...
    private UserCalorieSchedule GetCalorieSchedule() {
