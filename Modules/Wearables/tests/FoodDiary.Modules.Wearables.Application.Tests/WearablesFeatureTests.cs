...
public class WearablesFeatureTests {
    ...
    public async Task GetWearableDailySummary_WithEmptyUserId_ReturnsInvalidToken() {
        var handler = new GetWearableDailySummaryQueryHandler(new InMemoryWearableSyncRepository(), CreateCurrentUserAccessService());
    ...
    public async Task GetWearableDailySummary_WithEntries_ReturnsMappedSummary() {
        ...
        var handler = new GetWearableDailySummaryQueryHandler(repository, CreateCurrentUserAccessService());
    ...
    public async Task GetWearableConnections_WithEmptyUserId_ReturnsInvalidToken() {
        var handler = new GetWearableConnectionsQueryHandler(new InMemoryWearableConnectionRepository(), CreateCurrentUserAccessService());
    ...
    public async Task GetWearableConnections_WithConnections_ReturnsModels() {
        ...
        var handler = new GetWearableConnectionsQueryHandler(repository, CreateCurrentUserAccessService());
