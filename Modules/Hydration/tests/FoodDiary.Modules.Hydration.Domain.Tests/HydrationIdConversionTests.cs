...
public sealed class HydrationIdConversionTests {
    [Fact]
    public void HydrationEntryId_PreservesValueAcrossConversionsAndFormatting() {
        var value = Guid.Parse("12345678-1234-1234-1234-1234567890ab");
        var id = (HydrationEntryId)value;
        Guid roundTrip = id;
        ...
        Assert.Multiple(
            ...
            () => Assert.Equal(Guid.Empty, HydrationEntryId.Empty.Value));
    }
}
