...
Errors/ImpersonationErrors owns impersonation rejection errors consumed by Admin
workflows and API middleware. Keep their existing Authentication-prefixed codes.
