...
Own AdminImpersonationSession and its invariants. Keep scalar UserId dependencies one-way toward Users Domain.Contracts and place entities directly in `Entities` with namespace `FoodDiary.Modules.Admin.Domain.Entities`. No EF or application dependencies.
