...
namespace FoodDiary.Modules.OpenFoodFacts.Application.Tests;
...
public class OpenFoodFactsFeatureTests {
    ...
    public async Task SearchProducts_WhenResultsFound_ReturnsList() {
        ...
        SearchOpenFoodFactsQueryHandler handler = CreateCachedProductSearch(service, cache, unitOfWork);
    ...
    public async Task SearchProducts_WhenNoResults_ReturnsEmptyList() {
        IOpenFoodFactsService service = CreateOpenFoodFactsService(barcodeResult: null, []);
        SearchOpenFoodFactsQueryHandler handler = CreateCachedProductSearch(service);
    ...
    public async Task SearchProducts_WhenCacheHasEnoughResults_DoesNotCallExternalSearch() {
        ...
        SearchOpenFoodFactsQueryHandler handler = CreateCachedProductSearch(service, CreateOpenFoodFactsProductCacheRepository(cachedProducts), CreateUnitOfWork());
    ...
    private static SearchOpenFoodFactsQueryHandler CreateCachedProductSearch(
        ...
        return new SearchOpenFoodFactsQueryHandler(
            service,
            productCache,
            productCache,
