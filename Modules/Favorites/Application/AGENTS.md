...
- Use module-owned contracts and approved central compatibility contracts for other business areas. Own Favorites repository/source-reader ports in `../Application.Abstractions` and public read projections in `../Contracts`.
