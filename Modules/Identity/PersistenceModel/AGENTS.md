...
This is replay persistence state, not a new domain aggregate. Use project-and-folder CLR namespaces; preserve fingerprint key/length, expiry column/index and table identity; do not
