...
- Reference Cycles Domain.Contracts directly for cycle enums already exposed by those read models; do not acquire Cycles aggregates or repositories.
- Reference Meals Domain.Contracts directly for MealType already exposed by diary read models; preserve CSV formatting and continue to use existing read capabilities.
