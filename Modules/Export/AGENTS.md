...
- Keep PDF rendering, resource contracts and remote-image transport tests under tests/FoodDiary.Modules.Export.Infrastructure.Tests. Keep HTTP, host, architecture, and cross-module integration coverage with their existing owners.
