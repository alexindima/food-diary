...
- Keep USDA reference-data entities in the module Domain. Products retains a scalar UsdaFdcId; central persistence composition owns the schema-equivalent relationship. Do not add a reverse Domain dependency.
...
remain unchanged. Contracts imports Mediator, Results and scalar Products/Users contracts.
