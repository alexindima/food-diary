...
HealthArea value-object and calculation tests belong to the USDA Domain suite. Preserve moved cases; USDA score-boundary assertions from the retired mixed donor are owned here; Products assertions belong to Products.Domain.Tests.
