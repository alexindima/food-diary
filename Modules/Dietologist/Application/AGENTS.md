...
- Depend on Dietologist Domain/Application.Abstractions, Users Domain.Contracts, shared application abstractions and Mediator, as declared in the project reference matrix.
