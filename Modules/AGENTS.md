...
- Admin, Ai, Billing and BodyMetrics have completed this migration for their public use-case entrypoints. Their Contracts projects must not introduce service interfaces; CrossModuleRequestBoundaryTests protects that boundary.
