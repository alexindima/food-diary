...
public sealed class DashboardHttpMappingsTests {
    ...
    public void GetDashboardSnapshotHttpQuery_ToQuery_MapsAllFields() {
        ...
        var httpQuery = new GetDashboardSnapshotHttpQuery(date, 2, 20, "ru", 14, 240, "Asia/Tbilisi");
        ...
        Assert.Equal("Asia/Tbilisi", query.TimeZoneId);
    }
        ...
        var model = new DashboardSnapshotModel(
            ...
            new CycleModel(
                ...
                new CyclePredictionsModel(
                    DateOnly.FromDateTime(date.AddDays(17)),
                    DateOnly.FromDateTime(date.AddDays(19)),
                    OvulationFrom: null,
                    OvulationTo: null,
                    DateOnly.FromDateTime(date.AddDays(13)),
                    DateOnly.FromDateTime(date.AddDays(19)),
                    "Medium",
                    "test",
                    "Limited",
