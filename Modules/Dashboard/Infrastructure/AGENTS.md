...
Keep IDashboardReadService composition in Application. AddDashboardReadServices replaces only persistence-oriented ports and must not override ComposedDashboardReadService.
