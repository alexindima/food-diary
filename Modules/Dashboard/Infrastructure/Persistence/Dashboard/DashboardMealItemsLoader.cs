    ...
    public async Task<ILookup<MealId, DashboardMealItemReadModel>> LoadAsync(
        ...
        List<DashboardMealItemProjection> items = await context.MealItems
            ...
            .Select(item => new DashboardMealItemProjection(
                ...
                context.Products.Where(product => product.Id == item.ProductId).Select(product => product.Name).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => product.ImageUrl).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (string?)product.BaseUnit.ToString()).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (double?)product.BaseAmount).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (double?)product.CaloriesPerBase).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (double?)product.ProteinsPerBase).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (double?)product.FatsPerBase).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (double?)product.CarbsPerBase).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (double?)product.FiberPerBase).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (double?)product.AlcoholPerBase).SingleOrDefault(),
                context.Products.Where(product => product.Id == item.ProductId).Select(product => (ProductType?)product.ProductType).SingleOrDefault(),
