...
public static class MealMappings {
    public static MealModel ToModel(
        this MealProjectionReadModel meal,
    ...
    private static MealItemModel ToItemModel(MealItemProjectionReadModel item) {
    ...
    private static MealAiSessionModel ToAiSessionModel(MealAiSession session) {
    ...
    private static MealAiSessionModel ToAiSessionModel(MealAiSessionProjectionReadModel session) {
        return new MealAiSessionModel(
            session.Id,
            session.MealId,
    ...
    private static MealAiItemModel ToAiItemModel(MealAiItem aiItem) {
    ...
    private static MealAiItemModel ToAiItemModel(MealAiItemProjectionReadModel aiItem) {
        return new MealAiItemModel(
            aiItem.Id,
            aiItem.SessionId,
            aiItem.NameEn,
