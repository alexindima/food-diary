...
registration. No dependency on shared DbContext. Use canonical configuration namespaces; preserve tables, indexes, xmin, converters, field access, delete behavior and
