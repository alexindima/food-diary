...
- Shared DbContext, HTTP, host, and relational cross-module tests retain their composition owners. Domain invariants from the retired mixed donor belong to the module Domain.Tests. Do not duplicate them here.
