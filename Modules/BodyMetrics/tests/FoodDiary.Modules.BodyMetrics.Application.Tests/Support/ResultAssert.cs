...
namespace FoodDiary.Modules.BodyMetrics.Application.Tests.Support;

[ExcludeFromCodeCoverage]
public static class ResultAssert {
    public static void Success(Result result) {
        Assert.True(result.IsSuccess, $"Expected a successful result, but got '{result.Error.Code}': {result.Error.Message}");
    }
