...
- Use `FoodDiary.Modules.BodyMetrics.Application.Abstractions` with feature-relative namespaces. Keep separate write and read-model ports; public read services belong to Contracts.
