...
- Own weight and waist commands, queries, handlers, validation, mappings, and read request handlers.
...
Name ISender dependencies sender or mediator; do not retain the names of retired read services.
