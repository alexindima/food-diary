...
if ($sqlAverage -gt ($jsonAverage + 100)) {
    throw "SQLite impact-simulation route exceeded its 100ms end-to-end parity envelope: SQL=${sqlAverage}ms, JSON=${jsonAverage}ms."
}
