...
if ($verifyBody -notmatch '\$includesColdCheckoutGuard' -or
    $verifyBody -notmatch "verifyStageExpectedSeconds\['affected smoke'\].*450.*360" -or
    $verifyBody -notmatch 'Timeout\s*=.*720.*600') {
