...
internal sealed partial class DiaryPdfGenerator {
    private static void ComposeMealsCards(IContainer container, DiaryReportData report) {
        IReadOnlyList<MealProjectionReadModel> meals = report.Meals;
    ...
    private static void ComposeMealCard(IContainer container, DiaryReportData report, MealProjectionReadModel meal) {
    ...
    private static string[] GetMealTableValues(MealProjectionReadModel meal, DiaryReportData report) => [
    ...
    private static void ComposeMealItemsList(IContainer container, DiaryReportData report, MealProjectionReadModel meal) {
