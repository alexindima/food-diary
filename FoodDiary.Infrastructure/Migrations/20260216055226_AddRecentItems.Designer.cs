...
namespace FoodDiary.Infrastructure.Migrations
{
    ...
    [Migration("20260216055226_AddRecentItems")]
    partial class AddRecentItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.AiUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.DailyAdvice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.EmailTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.HydrationEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.MealAiItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.RecentItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.ShoppingList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.ShoppingListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.MealAiItem", b =>
                {
                    b.HasOne("FoodDiary.Domain.Entities.MealAiSession", "Session")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.ShoppingListItem", b =>
                {
                    ...
                    b.HasOne("FoodDiary.Domain.Entities.ShoppingList", "ShoppingList")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FoodDiary.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("FoodDiary.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
