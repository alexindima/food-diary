...
## Scope
Rules for `FoodDiary.MailInbox.Presentation/`.
...
- May reference `FoodDiary.MailInbox.Application`; do not reference infrastructure or host projects.
...
## Commands
- Build: `dotnet build FoodDiary.MailInbox.Presentation/FoodDiary.MailInbox.Presentation.csproj`
