...
## Scope
Rules for `MailInbox/FoodDiary.MailInbox.Initializer/`.
...
## Architecture
- Keep persistence mappings and migrations in `MailInbox/FoodDiary.MailInbox.Infrastructure`.
...
## Commands
- Build: `dotnet build MailInbox/FoodDiary.MailInbox.Initializer/FoodDiary.MailInbox.Initializer.csproj`
