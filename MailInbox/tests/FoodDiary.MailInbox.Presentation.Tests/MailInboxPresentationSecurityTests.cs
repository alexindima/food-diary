...
public sealed class MailInboxPresentationSecurityTests {
    ...
    public void MailInboxHttpOptions_RejectsUnsafeBounds() {
        ...
        MailInboxHttpOptions[] invalidOptions = [
            ...
            CreateOptions(messageMetadataQueueTimeout: TimeSpan.FromSeconds(6)),
            CreateOptions(messageMetadataExecutionTimeout: TimeSpan.Zero),
            CreateOptions(messageMetadataExecutionTimeout: TimeSpan.FromSeconds(31)),
