...
public sealed class MailInboxReadinessConcurrencyFilter(MailInboxReadinessConcurrencyGate gate)
    ...
    public async Task OnResourceExecutionAsync(
        ...
        if (lease is null) {
            ...
            context.Result = new ObjectResult(new MailInboxApiErrorHttpResponse(
                "MailInbox.ReadinessCapacityExceeded",
                "Mail inbox readiness capacity is temporarily exhausted.",
