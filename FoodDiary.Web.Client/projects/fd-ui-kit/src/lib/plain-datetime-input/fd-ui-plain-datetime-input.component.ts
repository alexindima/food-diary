...
@Component({
    selector: 'fd-ui-plain-datetime-input',
    standalone: true,
    imports: [
        CommonModule,
        ReactiveFormsModule,
    ...
    templateUrl: './fd-ui-plain-datetime-input.component.html',
    styleUrls: ['./fd-ui-plain-datetime-input.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef((): typeof FdUiPlainDatetimeInputComponent => FdUiPlainDatetimeInputComponent),
            multi: true,
        },
    ],
})
export class FdUiPlainDatetimeInputComponent implements ControlValueAccessor {
    public readonly id = input(`fd-ui-plain-datetime-input-${uniqueId++}`);
    ...
    protected get sizeClass(): string {
        return `fd-ui-plain-datetime-input--size-${this.size()}`;
    }
