...
import { type FdUiEmptyStateAppearance, FdUiEmptyStateComponent } from '../empty-state/fd-ui-empty-state';
import { FdUiSectionErrorStateComponent } from './fd-ui-section-error-state';
import { FdUiSectionLoadingStateComponent } from './fd-ui-section-loading-state';
...
@Component({
    ...
    templateUrl: './fd-ui-section-state.html',
