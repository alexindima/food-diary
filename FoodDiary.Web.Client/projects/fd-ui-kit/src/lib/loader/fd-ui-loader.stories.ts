...
export const InContext: Story = {
    render: () => ({
        template: `
            <div style="display: flex; flex-direction: column; align-items: center; gap: 16px; padding: 48px; background: #f5f5f5; border-radius: 8px;">
                <fd-ui-loader></fd-ui-loader>
                <p style="margin: 0; color: #666; font-size: 14px;">Loading data...</p>
            </div>
        `,
    }),
};
