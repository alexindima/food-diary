...
- `--fd-line-chart-point-size` (defaults to `10px`; use smaller markers for compact sparklines)
- `--fd-line-chart-y-axis-gap` (defaults to `--fd-space-sm`, reserving room between Y labels and edge markers)
