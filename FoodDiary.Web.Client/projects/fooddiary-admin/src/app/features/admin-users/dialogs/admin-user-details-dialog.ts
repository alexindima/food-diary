        ...
        return [
            ...
            },
            {
                ...
                fields: [
                    ...
                    { label: 'Height', value: this.number(currentUser.heightCm) },
                    { label: 'Weight', value: this.number(currentUser.weightKg) },
                    { label: 'Desired weight', value: this.number(currentUser.desiredWeightKg) },
                    { label: 'Desired waist', value: this.number(currentUser.desiredWaistCm) },
