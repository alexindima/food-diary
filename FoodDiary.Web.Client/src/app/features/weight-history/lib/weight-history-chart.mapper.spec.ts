...
describe('weight history chart mapper', () => {
    ...
    it('adds the year when the range is not entirely within the current year', () => {
        const points = buildWeightHistoryChartPoints(
            [
                { startDate: '2025-12-31T00:00:00Z', endDate: '2025-12-31T23:59:59Z', averageWeight: AVERAGE_WEIGHT },
                { startDate: '2026-01-01T00:00:00Z', endDate: '2026-01-01T23:59:59Z', averageWeight: AVERAGE_WEIGHT },
            ],
            'en',
            CURRENT_YEAR,
        );
    ...
    it('uses short localized month labels', () => {
        const points = buildWeightHistoryChartPoints(
            [{ startDate: '2026-07-05T00:00:00Z', endDate: '2026-07-05T23:59:59Z', averageWeight: AVERAGE_WEIGHT }],
            'ru',
            CURRENT_YEAR,
        );
