...
describe('ProductFavoritesPickerComponent', () => {
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({
            imports: [ProductFavoritesPickerComponent],
            providers: [
                provideTranslateTesting(),
                { provide: FavoriteProductService, useValue: api },
...
function registerUndoRenderingTests(): void {
    it('renders several inline undo rows and restores the clicked row in place', async () => {
        ...
        fixture.detectChanges();
        await fixture.whenStable();
        const rows = element.querySelectorAll('fd-favorite-product-row');
...
function registerPickerAsyncTests(): void {
    ...
    it('surfaces thrown add and removal errors, allowing retry', () => {
        ...
        component['add'](favorite);
        expect(component['operationErrorKey']()).toBe('PRODUCT_FAVORITES.ADD_ERROR');
        component['load'](1);
        remove.mockReturnValueOnce(throwError(() => new Error('offline')));
        component['remove'](favorite);
        expect(component['operationErrorKey']()).toBe('PRODUCT_FAVORITES.REMOVE_ERROR');
        expect(component['busy']()).toBe(false);
        component['changePage'](2);
