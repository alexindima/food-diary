...
import { WeightTrendCardComponent } from '../../../components/weight-trend-card/weight-trend-card';
...
@Component({
    ...
    templateUrl: './dashboard-trend-block.html',
...
export class DashboardTrendBlockComponent {
    ...
    public readonly titleKey = input<string>('WEIGHT_CARD.TITLE');
