...
import { EntityCardActionsComponent } from './entity-card-actions/entity-card-actions';
import { EntityCardBodyComponent } from './entity-card-body/entity-card-body';
...
import { EntityCardThumbComponent } from './entity-card-thumb/entity-card-thumb';
