...
import { DynamicProgressBarComponent } from '../dynamic-progress-bar/dynamic-progress-bar';
...
@Component({
    ...
    templateUrl: './daily-progress-card.html',
    styleUrl: './daily-progress-card.scss',
