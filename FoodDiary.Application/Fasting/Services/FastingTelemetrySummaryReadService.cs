...
public sealed class FastingTelemetrySummaryReadService(
    IFastingTelemetryEventReadRepository repository,
    TimeProvider timeProvider)
    : IFastingTelemetrySummaryReadService {
    public async Task<Result<FastingTelemetrySummaryModel>> GetAsync(int hours, CancellationToken cancellationToken) {
