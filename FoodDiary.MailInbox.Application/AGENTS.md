...
## Scope
Rules for `FoodDiary.MailInbox.Application/`.
...
- Depend only on `FoodDiary.MailInbox.Domain` and `Shared/FoodDiary.Mediator` among local production projects.
...
## Commands
- Build: `dotnet build FoodDiary.MailInbox.Application/FoodDiary.MailInbox.Application.csproj`
